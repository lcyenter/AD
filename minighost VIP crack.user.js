...
// @namespace    hoothin
// @version      1.7.8
// @description  💎全面破解各大视频站（优酷，土豆视频，华数TV，搜狐视频，PPTV，ACFUN，腾讯视频，乐视视频，芒果TV，爱奇艺，哔哩哔哩，音悦台等网站）的VIP会员视频，有全网最全面的▶34◀个接口。电视剧选集也不需要直接播放页就能正确解析。
...
(function() {
    'use strict';
    var cracks=[
        {name:"通道1",url:"https://api.47ks.com/webcloud/?v=%s",title:"首选"},
        {name:"通道2",url:"http://www.wmxz.wang/video.php?url=%s",title:"次选"},
        {name:"通道3",url:"https://jiexi.071811.cc/jx.php?url=%s"},
        {name:"通道4",url:"https://aikan-tv.com/tong.php?url=%s"},
        {name:"通道5",url:"https://www.zuixiaopin.com/api/cloudVideo?url=%s"},
        {name:"通道6",url:"https://www.yymeier.com/api.php?url=%s"},
        {name:"通道7",url:"https://jxapi.nepian.com/ckparse/?url=%s"},
        {name:"通道8",url:"https://www.vipjiexi.com/yun.php?url=%s"},
        {name:"通道9",url:"https://ckplaer.duapp.com/hai2.php?url=%s",title:"播放器似乎放在百度开发者平台"},
        {name:"通道10",url:"http://jx.ck921.com/hai2.php?url=%s",title:"和上面的用的应该是同样的服务器"},
        {name:"通道11",url:"http://yyygwz.com/index.php?url=%s"},
        {name:"通道12",url:"http://parse.colaparse.cc/?url=%s"},
        {name:"通道13",url:"http://www.jiexi.cx/5qiyi/?url=%s"},
        {name:"通道14",url:"http://moon.moondown.net/?url=%s"},
        {name:"通道15",url:"http://jx.xuanpianwang.com/parse?url=%s"},
        {name:"通道16",url:"http://www.ou522.cn/t2/1.php?url=%s"},
        {name:"通道17",url:"http://000o.cc/jx/ty.php?url==%s"},
        {name:"通道18",url:"http://s1y2.com/?url=%s"},
        {name:"通道19",url:"http://yun.zihu.tv/api.php?url=%s"},
        {name:"通道20",url:"http://www.tuhao13.com/yunparse/index.php?url=%s"},
        {name:"通道21",url:"http://qtzr.net/s/?qt=%s"},
        {name:"通道22",url:"http://www.97zxkan.com/jiexi/97zxkanapi.php?url=%s"},
        {name:"通道23",url:"http://jx.71ki.com/tong.php?url=%s"},
        {name:"通道24",url:"http://api.cloudparse.com/?url=%s"},
        {name:"通道25",url:"http://player.gakui.top/?url=%s"},
        {name:"通道26",url:"http://www.ppypp.com/yunparse/?url=%s"},
    ...
    if(!GM_getValue("hacgGodTurnVisited")){
        select.innerHTML+="<option value='http://39.108.50.212:8080/GaoDianShaWeb/'>\u2605\u4e0a\u8f66\u2605</option>";
    }
    ...
    embedLabel.title="勾选我以在当前页面直接破解播放";
    embedLabel.innerHTML="<input type='checkbox'>嵌入页面";
